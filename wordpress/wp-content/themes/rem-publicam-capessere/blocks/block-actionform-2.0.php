        ...
        ?>
            ...
            foreach ($step["fields"] as $name => $field) :
                ...
                <div class="input-wrapper <?= $field["type"] ?><?= (isset($field["fullwidth"])) ? " fullwidth" : "" ?>">
                    ...
                    ?>
                    <input type="checkbox" name="<?= $name ?>" id="<?= $name ?>-<?=$formid?>" class="<?= $name ?>" hidden<?= (isset($field["checked"])) ? " checked" : "" ?><?= (isset($field["merge"])) ? " data-merge='{$field["merge"]}'" : "" ?><?= (isset($field["mtag"])) ? " data-mtag='{$field["mtag"]}'" : "" ?><?= (isset($field["is-optin"])) ? " data-is-optin='true'" : "" ?><?= (isset($field["base_config"])) ? " data-base-config='" . $field["base_config"] . "'" : "" ?>>
                    ...
                    <textarea name="<?= $name ?>" class="rpc-textarea-autosize" id="<?= $name ?>-<?=$formid?>"<?= (isset($field["class"])) ? " class='{$field["class"]}'" : "" ?><?= (isset($field["required"])) ? " required" : "" ?><?= (isset($field["max-length"])) ? " maxlength='{$field["max-length"]}'" : "" ?><?= (isset($field["merge"])) ? " data-merge='{$field["merge"]}'" : "" ?><?= (isset($field["mtag"])) ? " data-mtag='{$field["mtag"]}'" : "" ?><?= (isset($field["is-address"])) ? " data-is-address='true'": "" ?><?= (isset($field["is-address"])) ? " data-address-field='{$field["address-field"]}'": "" ?><?= (isset($field["base_config"])) ? " data-base-config='" . $field["base_config"] . "'" : "" ?>><?= isset($field["placeholder"]) ? $field["placeholder"] : "" ?></textarea>
                    <?php
                    else:
                    ?>
                    <label for="<?= $name ?>-<?=$formid?>" class="text-xl"><?= $field["label"] ?></label>
                    <input type="<?= $field["type"]?>" name="<?= $name ?>" id="<?= $name ?>-<?=$formid?>"<?= (isset($field["class"])) ? " class='{$field["class"]}'" : "" ?><?= (isset($field["required"])) ? " required" : "" ?><?= (isset($field["merge"])) ? " data-merge='{$field["merge"]}'" : "" ?><?= (isset($field["mtag"])) ? " data-mtag='{$field["mtag"]}'" : "" ?><?= (isset($field["is-address"])) ? " data-is-address='true'": "" ?><?= (isset($field["is-address"])) ? " data-address-field='{$field["address-field"]}'": "" ?><?= (isset($field["base_config"])) ? " data-base-config='" . $field["base_config"] . "'" : "" ?><?= (isset($field["img_crop"])) ? " data-img-crop='{$field["img_crop"]}'" : "" ?><?= isset($field["placeholder"]) ? " placeholder='{$field["placeholder"]}'" : "" ?><?= (isset($field["default-value"])) ? " value='{$field["default-value"]}'" : "" ?>">
                    <?php
                    endif;
